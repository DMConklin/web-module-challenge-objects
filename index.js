...
let taco = createMenuItem('taco',2,'Dinner')
console.log(taco)
let frenchToast = createMenuItem('french toast',3,'Breakfast')
console.log(frenchToast)
let sub = createMenuItem('sub',10,'Lunch')
console.log(sub)
...
const reviews = [
    ...
    {name: "Reyna", rating: 3.5, feedback: "testing"},
]
...
*/
 ...
 function getReviewByRating(/* code here */reviews, rating) {
    /* code here */
...
function getLongReviews(/* code here */reviews) {
    /* code here */
